...
import { ArrowUpOutlined, CheckCircleOutlined, FormOutlined, WarningOutlined } from "@ant-design/icons"
  ...
  return (
    <CBox>
      ...
      <SBox>
        <Card bordered={false}>
          <Statistic
            title= {<>Выполненные задачи. <br/> Всего {discription.doneProc}</>}
        ...
        <Card bordered={false}>
          <Statistic
            title= {<>Просроченные задачи. <br/> Всего {discription.doneProc}</>}
        ...
        <Card bordered={false}>
          <Statistic
            title= {<>Текущие задачи. <br/> Всего {discription.doneProc}</>}
